...
<head>
    <title>Raden Muhammad Raissa Wirabuwana 5026241097</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
        <div class="mt-4 p-5 bg-primary text-white rounded">
            <h3>5026241097 Raden Muhammad Raissa Wirabuwana</h3>
            <h6>@yield('title')</h6>
        ...
        <nav class="navbar navbar-expand-sm bg-light navbar-light">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('kabel*') ? 'active' : '' }}" href="/kabel">Kabel</a>
                    </li>
                    <li class="nav-item">
